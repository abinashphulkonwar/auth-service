...
const { signUpLimite, logInLimite, forgetPassword } = require("../utils/requestLimit");
...
router.route("/user").post(userAuthentication, userDuplicationError, userConttroler.getUser)
...
router
  ...
  .post(userAuthentication, changePasswordValidationData, changePasswordControler.changePassword);

router.post("/forget-password").post(forgetasswordValidationData, forgetPassword, forgetPasswordControler.forgetPassword)
